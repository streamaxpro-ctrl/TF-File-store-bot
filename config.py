...
OWNER_ID = int(os.environ.get("OWNER_ID", "8098519590"))
DB_URL = os.environ.get("mongodb+srv://streamaxbot:streamax100@cluster0.vablnbw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", "")
DB_NAME = os.environ.get("DB_NAME", "StreamaxBot")


CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002948066604"))

FORCE_SUB_CHANNEL_1 = int(os.environ.get("FORCE_SUB_CHANNEL_1", "-1001962087037"))

FORCE_SUB_CHANNEL_2 = int(os.environ.get("FORCE_SUB_CHANNEL_2", "-1002086851538"))

FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1002021389580"))

FORCE_SUB_CHANNEL_4 = int(os.environ.get("FORCE_SUB_CHANNEL_4", "-1002029219126"))
